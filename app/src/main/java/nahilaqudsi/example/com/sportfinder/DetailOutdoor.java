...
public class DetailOutdoor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDetailMaps.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent a = new Intent(DetailOutdoor.this,MapsActivity.class);
...
//
    ...
    public void callTelepon()
    {
        ...
        if (ContextCompat.checkSelfPermission(DetailOutdoor.this, android.Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(DetailOutdoor.this, new String[]{android.Manifest.permission.CALL_PHONE},REQUEST_PHONE_CALL);
        }
        else
        {
