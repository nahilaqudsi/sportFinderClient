...
public class DetailIndor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDetailMaps.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent a = new Intent(DetailIndor.this,MapsActivity.class);
        ...
        btnDetailFav.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
//                String btn = String.valueOf(btnDetailFav.getTag());
                Uri path = Uri.parse("android.resource://nahilaqudsi.example.com.sportfinder/" + R.drawable.heart_grey);
                String imgPath = path.toString();
                if (imgPath.equals("android.resource://nahilaqudsi.example.com.sportfinder/" + R.drawable.heart_grey)) {
                    btnDetailFav.setBackgroundResource(R.drawable.heartred);
                }

                if (imgPath.equals("android.resource://nahilaqudsi.example.com.sportfinder/" + R.drawable.heartred)) {
                    btnDetailFav.setBackgroundResource(R.drawable.heart_grey);
                }
...
//
    ...
    public void callTelepon()
    {
        ...
        if (ContextCompat.checkSelfPermission(DetailIndor.this, android.Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(DetailIndor.this, new String[]{android.Manifest.permission.CALL_PHONE},REQUEST_PHONE_CALL);
        }
        else
        {
